...
class _VauvaPageSpider(FollowAndParseItemMixin, Spider):
    ...
    def __init__(self, follow_link_extractor=None,
        ...
        article_suffix = r'[A-z0-9\-]+'

        self.start_urls = ['https://vauva.fi']
        self.allow_follow = (r'.*\/keskustelu\/.*')
        self.allow_items = (rf'keskustelu/[0-9]+/{article_suffix}')

        self.allow_domains = ('vauva.fi')
        self.deny_domains = ()
        self.deny = ('quote', 'changed', 'user', r'(\&|\?)(rate)\=')
